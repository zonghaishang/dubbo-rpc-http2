...
import org.apache.dubbo.rpc.protocol.http2.Http2Protocol;

import java.util.Collection;

public class Http2ProtocolUtils {
    ...
    public static void closeAll() {
        Http2Protocol.getHttp2Protocol().destroy();
        Collection<ExchangeServer> servers = Http2Protocol.getHttp2Protocol().getServers();
