...
public class ReferenceCountExchangeClientTest {
    ...
    private void init(int connections) {
        ...
        URL demoUrl = URL.valueOf("http2://127.0.0.1:" + port + "/org.apache.dubbo.rpc.protocol.http2.IDemoService?" + Constants.CONNECTIONS_KEY + "=" + connections);
        URL helloUrl = URL.valueOf("http2://127.0.0.1:" + port + "/org.apache.dubbo.rpc.protocol.http2.IHelloService?" + Constants.CONNECTIONS_KEY + "=" + connections);
